...
const GlobalResult = () => {
  ...
  const [result, setResult] = useState([
    ...
    { type: "tag", id: 1, title: "tag" },
    { type: "user", id: 1, title: "john" },
  ]);
            ...
            {result.length > 0 ? (
              result.map((item: any, index: number) => (
                <Link
                  ...
                  className="item-start flex w-full cursor-pointer gap-3 px-5 py-2.5 hover:bg-light-700/50 dark:hover:bg-dark-500/50"
                >
                  <Image
